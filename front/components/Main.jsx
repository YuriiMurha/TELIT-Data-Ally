...
const Main = () => {
  ...
  useEffect(() => {
    ...
    const splitTypes = refs.map((ref, index) =>
      createAnimation(ref, tl, animationParams[index])
    );
  ...
  return (
    <div id="Home">
      <div className=" gradient-background w-full h-auto mx-auto p-2  justify-center items-center mb-5">
        <div
          className="flex flex-col  justify-between py-16 items-center h-full w-full md:text-center xs:text-left"
        ...
        >
          <div className=" frosted-glass-small flex md:flex-row flex-col gap-0 md:gap-32 justify-between mt-24 px-28 py-5 rounded-xl  border-2 border-pink-400">
            <div className="text-[#ffffff]   flex flex-col justify-center font-viola text-start xs:text-8xl">
              ...
              <div className="text-[5vw] pt-5 text-[#2f2f2f]">
                {" "}
                <span className="text-[#2f2f2f]">AI </span>{" "}
                <span className="text-[#FA4AA5]">Dashboard</span>{" "}
              </div>
            </div>
            ...
            <div className="relative" style={{ overflow: "visible" }}>
              <Suspense fallback={null}>
                ...
                >
                  ...
                  <div
                    className="text-[#FA4AA5] font-mono text-sm uppercase"
                    style={{
                      position: "absolute",
                      bottom: "-5px",
                      right: "0px",
          ...
          <div className="mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
            <div className="flex gap-10 flex-col lg:flex-row ">
              <div className="grid gap-5 row-gap-5 sm:grid-cols-2">
                <div className="max-w-md flex flex-col frosted-glass-full rounded-2xl p-5 text-left border border-pink-400 ">
                  ...
                  <p className="text-sm  text-[#2f2f2f]">
                    Smarter decisions and seamless communication with innovative
                    AI
                  </p>
                </div>
                <div className="max-w-md flex flex-col frosted-glass-full rounded-2xl p-5 text-left border border-pink-400 ">
                  ...
                  <p className="text-sm text-[#2f2f2f]">
                    Redefining networks and customer engagement with AI-powered
                    efficiency
                  </p>
                </div>
              </div>
              ...
              <a href="http://localhost:3000/dashboard">
                <div
                  id="bottone1"
                  className="max-w-xl  mx-auto bg-[#FA4AA5] text-white  rounded-2xl pt-10 px-7 pb-0 text-left"
                >
                  ...
                  <div className="flex flex-row gap-3 justify-start items-center">
                    <p className=" text-white">
                      Harnessing artificial intelligence to deliver smarter,
                      faster, and more reliable solutions for modern telecom
                      challenges.
                    </p>
                    <svg
                      width="84px"
