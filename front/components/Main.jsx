                    ...
                    <div className=' frosted-glass-small flex md:flex-row flex-col gap-0 md:gap-32 justify-between mt-24 px-28 py-5 rounded-xl  border-2 border-pink-400'>
                        <div className="text-[#ffffff]   flex flex-col justify-center font-viola text-start xs:text-8xl">
                            <div className='flex felx-row gap-5'>
                                ...
                                <div className=' text-[6vw] text-[#FA4AA5]'>Allyce</div>
                            </div>
                            <div className='text-[5vw] pt-5 text-[#2f2f2f]'> <span className='text-[#2f2f2f] fancy'>Smart </span> <span>Data</span>   <span className='text-[#2f2f2f]'>Ally</span> </div>
                        </div>
                            ...
                            <div className="grid gap-5 row-gap-5 sm:grid-cols-2">
                                <div className="max-w-md flex flex-col frosted-glass-full rounded-2xl p-5 text-left border border-pink-400 ">
                                    ...
                                    <p className="text-sm  text-[#2f2f2f]">
                                        Boost your business with CSV analysis, charts, and real-time insights.
                                    </p>
                                </div>
                                <div className="max-w-md flex flex-col frosted-glass-full rounded-2xl p-5 text-left border border-pink-400 ">
                                    <div className="flex items-center justify-center w-11 h-11 mb-4 rounded-full bg-[#FA4AA5]">
                                    ...
                                    <p className="text-sm text-[#2f2f2f]">
                                        Fast responses and instant visualizations streamline decision-making like never before.
                                    </p>
                                </div>
                            </div>

                            <a  href='http://localhost:3000/dashboard' id="bottone1" className="max-w-xl  mx-auto bg-[#FA4AA5] text-white  rounded-2xl pt-10 px-7 pb-0 text-left">
                                <h5 className=" text-3xl font-extrabold  leading-none">
                                AI-Powered Insights
                                </h5>
                                <div className='flex flex-row gap-3 justify-start items-center'>
                                    <p className=" text-white">
                                        Gain smart, fast, and reliable solutions for data analysis and real-time decision-making.
                                    </p>
